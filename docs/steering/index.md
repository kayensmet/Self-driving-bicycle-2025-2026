...
* **Iteration 2 (Laser-cut MDF):** Switching to custom laser-cut gears provided excellent profile accuracy, but standard-thickness materials still yielded under the immense localized bending moments at the axile center.
* **The Masterstroke (Hybrid Material Composites):** To perfectly balance weight, precision, and brutal strength, we engineered a hybrid drivetrain. By pairing an ultra-thick, heavy-duty hardwood gear on the main steering column with a precision 3D-printed driving gear on the servo, we achieved the perfect friction-and-strength coefficient. This custom-engineered pairing completely neutralized the motor's immense force, turning raw torque into flawless, reliable steering control.
