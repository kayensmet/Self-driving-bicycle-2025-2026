...
| Steering | Servo control, gear/chain drive |
| Drive | Hub motor, motor controller, throttle|
| Communication | ESP-NOW, MQTT, controller |
...
| Folder | Description |
|---|---|
| `src/balance/` | PID controller, LQR controller, tuning dashboard |
