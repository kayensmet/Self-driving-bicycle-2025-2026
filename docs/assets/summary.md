...
## Communication
- **Group 1** Used a PS5 controller, ESP-NOW communication, and a Node-RED dashboard. See more at [Communication group 1](https://github.com/kayensmet/Self-driving-bicycle-2025-2026/blob/main/src/communication/group1/README.md).
